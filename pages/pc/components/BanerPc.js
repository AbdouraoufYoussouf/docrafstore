    ...
    <div className="w-full flex justify-between items-start my-2 rounded-lg relative heroheader max-lg:p-3 max-xm:p-2">
      <BannerLeft>
        <div className="top">
          ...
          <h2 className="name">Ordinateur portable</h2>
          <p className="offer">aujourd’hui derniere offre </p>
          <Link href='#pc'>
          <button className="shopnow hover:transform hover:scale-110 transition-transform duration-500 ease-in-out">Voir la collection</button>
        </Link>
        </div>
      ...
      <BannerCenter>
       <img src={"/products/pc/hppavion/1.png"}  />
      </BannerCenter>
      <BannerRight>
        <div className="top">
