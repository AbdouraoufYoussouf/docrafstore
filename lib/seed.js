...
// Créer des produits à partir des données de référence
Product.create(products)
  .then(() => {
    console.log("Données de référence enregistrées dans la base de données");
  })
  .catch((error) => {
    console.error(
      "Erreur lors de l'enregistrement des données de référence",
      error
    );
  });
